...
class CanvasPainting extends StatefulWidget {
  static const String idScreen = '/CanvasPainting';
  final String name;
  final int phnumber;
  final String address;
  
  CanvasPainting({this.name, this.phnumber, this.address});
  @override
...
class _CanvasPaintingState extends State<CanvasPainting> {
  ...
  Future<void> _save() async {
    ...
    print(pngBytes);
    final resulta = File.fromRawPath(pngBytes);
    picture = resulta;
    print(picture);
